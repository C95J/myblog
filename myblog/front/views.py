...
def index(request):
    ...
    return render(request, 'index_c.html', {'resume': resume,
                                            'results': results,
                                            'articles': articles,
                                            'first': first},)
...
def list(request):
    ...
    articles = pg.page(page)
    return render(request, 'list_c.html', {'resume': resume,
                                           'results': results,
                                           'articles': articles,
                                           'articles1': articles1,
                                           'first': first},)
...
def infopic(request, id):
    ...
    return render(request, 'infopic_c.html', {'resume': resume,
                                              'results': results,
                                              'article': article
                                              })
...
def about(request):
    ...
    return render(request, 'about_c.html', {'results': results})
